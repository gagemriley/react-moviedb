...
#### [Live](https://react-moviedb--gmr.herokuapp.com/)

## Description:
An application that allows users to search movies using the MovieDB API, created to better understand the React framework.
